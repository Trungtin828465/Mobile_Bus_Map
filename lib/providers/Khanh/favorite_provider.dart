...
// import 'package:busmap/models/Khanh/BusRoute/favorite_route.dart';
// import 'package:busmap/models/Khanh/favorite_stop.dart'; // Giả sử bạn có model FavoriteStop
// import 'package:busmap/service/Khanh/favorite_route_service.dart';
// import 'package:busmap/service/Khanh/favorite_stop_service.dart'; // Giả sử bạn có FavoriteStopService
//
...
import 'package:flutter/foundation.dart';
import 'package:busmap/models/Khanh/BusRoute/favorite_route.dart';
import 'package:busmap/models/Khanh/favorite_stop.dart';
import 'package:busmap/service/Khanh/favorite_route_service.dart';
import 'package:busmap/service/Khanh/favorite_stop_service.dart';

class FavoriteProvider with ChangeNotifier {
  final FavoriteRouteService _favoriteRouteService = FavoriteRouteService();
  final FavoriteStopService _favoriteStopService = FavoriteStopService();
  List<FavoriteRoute> _favoriteRoutes = [];
  List<FavoriteStop> _favoriteStops = [];
  bool _isLoadingRoutes = false;
  bool _isLoadingStops = false;
  String? _errorRoutes;
  String? _errorStops;
  ...
  Future<void> fetchFavoriteRoutes(int userId) async {
    try {
      _isLoadingRoutes = true;
      _errorRoutes = null;
      // Không gọi notifyListeners() ở đây để tránh lỗi trong build phase
      ...
      _isLoadingRoutes = false;
      notifyListeners(); // Chỉ gọi sau khi hoàn thành
    }
  }
