...
class UserChatDetailScreen extends StatefulWidget {
  ...
  const UserChatDetailScreen({super.key, required this.chatId});

  @override
  _UserChatDetailScreenState createState() => _UserChatDetailScreenState();
}

class _UserChatDetailScreenState extends State<UserChatDetailScreen> {
  final TextEditingController _messageController = TextEditingController();
  String _senderRole = "Admin"; // Mặc định là User
  ...
  Future<void> _loadSenderRole() async {
    ...
    setState(() {
      _senderRole = userId != 0 ? "User" : "Admin";
    });
